...
<p><?php esc_html_e('No results.', 'ovantis');?></p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
...
<h4 class="wp-block-heading"><?php esc_html_e('Search', 'ovantis');?></h4>
<!-- /wp:heading -->

<!-- wp:search {"label":"Search","showLabel":false,"placeholder":"Searching...","width":291,"widthUnit":"px","buttonText":"Search","style":{"border":{"radius":"20px"}},"backgroundColor":"custom-primary"} /-->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Latest Posts', 'ovantis');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Categories', 'ovantis');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Tags', 'ovantis');?></h4>
<!-- /wp:heading -->
